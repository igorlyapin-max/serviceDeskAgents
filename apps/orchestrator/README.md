...
Этап 12.7 упрощает `Сценарии обработки -> Профили разрешения`: профиль заполняет слот как resolver с признаками, операцией разрешения, правилами оценки результата, матрицей решений, вопросом уточнения и пакетом передачи человеку.
...
Этапы 13.6-13.7 были упрощены: фактическое действие эскалации вычисляется из выбранного канала взаимодействия без отдельных профилей действий канала.
